...
""".format(
    mod_count=B_MOD_COUNT, type_count=B_TYPE_COUNT, func_count=B_FUNC_COUNT
)
...
latex_documents = [
    (master_doc, "boltons.tex", "boltons Documentation", "Mahmoud Hashemi", "manual"),
]
...
man_pages = [(master_doc, "boltons", "boltons Documentation", [author], 1)]
